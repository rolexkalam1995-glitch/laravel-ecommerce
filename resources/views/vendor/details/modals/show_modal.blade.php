    <!-- Show Vendor Modal -->
    <div class="modal fade" id="show_vendor_details_modal_{{ $vendor->id }}" tabindex="-1"
        aria-labelledby="showVendorDetailsModalLabel{{ $vendor->id }}" aria-hidden="true" class="mt-0">
