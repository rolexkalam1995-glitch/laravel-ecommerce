   <!-- Edit Vendor Modal -->
   <div class="modal fade" id="edit_vendor_details_modal_{{ $vendor->id }}" tabindex="-1"
       aria-labelledby="editVendorDetailsModalLabel{{ $vendor->id }}" data-bs-backdrop="static" aria-hidden="true">
       <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-shadow custom_modal_dialog mx-auto">
           <div class="modal-content">
               ...
               <form action="{{ route('vendor.details.update', $vendor->id) }}" method="POST"
                   ...
                   <div class="modal-body role_modal_body mx-3 mt-3 custom_modal_body">
                       <div class="container p-2">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-sm-9">
                                   <input type="text" class="form-control" value="{{ $vendor->role }}" readonly>
                                   <input type="hidden" name="role" value="{{ $vendor->role }}">
