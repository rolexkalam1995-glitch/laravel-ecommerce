<!-- Create Vendor Modal -->
<div class="modal fade" id="add_vendor_modal" tabindex="-1" aria-labelledby="addVendorModalLabel" aria-hidden="true">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const vendorModalEl = document.getElementById('add_vendor_modal');
