                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control product_field" id="product_name"
                                                name="name" autocomplete="off" required oninput="admin_product_slug()">
                                ...
                                <div class="card p-2 mb-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        {{-- <fieldset class="mb-5 border-0">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input border border-dark p-2 product_field" type="radio"
                                        ...
                                        {{-- <div class="form-group mb-5">
                                            ...
                                            <input type="number" class="form-control product_field mb-1"
                                        ...
                                        <fieldset class="mb-4 border-0">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input border border-dark p-2 product_field"
                                                    ...
                                                    value="flat" {{ old('discount_type') == 'flat' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="discount_flat">Flat</label>
                                            </div>
